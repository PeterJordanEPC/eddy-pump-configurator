...
const QUESTIONS = {
  ...
  flow_pump: {
    ...
    options: [
      { id: "f_5_50", label: "5–50 GPM", desc: "Light transfer duty.", art: "flow" },
      { id: "f_50_200", label: "50–200 GPM", desc: "Small process lines.", art: "flow" },
      { id: "f_200_400", label: "200–400 GPM", desc: "Light plant duty.", art: "flow" },
      { id: "f_400_900", label: "400–900 GPM", desc: "Typical plant transfer.", art: "flow" },
      { id: "f_900_1600", label: "900–1,600 GPM", desc: "Heavy plant duty.", art: "flow" },
      { id: "f_1600_2500", label: "1,600–2,500 GPM", desc: "High-volume transfer.", art: "flow" },
      { id: "f_2500_3500", label: "2,500–3,500 GPM", desc: "High-volume transfer.", art: "flow" },
      { id: "f_3500_6000", label: "3,500–6,000 GPM", desc: "Major process lines.", art: "flow" },
      { id: "f_6000_12000", label: "6,000–12,000 GPM", desc: "Maximum-volume duty.", art: "flow" },
    ],
  },
  head: {
    key: "head",
